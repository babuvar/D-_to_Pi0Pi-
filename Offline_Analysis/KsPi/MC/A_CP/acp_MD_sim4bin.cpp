...
//Signal
  ...
  RooFormulaVar mean("mean","1.86978+#mu_{fudge}",RooArgList(m_fudge));
  RooFormulaVar sig("sig","0.01099*#sigma_{fudge}",RooArgList(s_fudge));
  RooFormulaVar sig1("sig1","0.00422*#sigma_{fudge}",RooArgList(s_fudge));
  RooFormulaVar sig2("sig2","0.00472*#sigma_{fudge}",RooArgList(s_fudge));
  RooRealVar f_Sig("f_Sig","f_Sig",0.258);
//Background
//Bin-1

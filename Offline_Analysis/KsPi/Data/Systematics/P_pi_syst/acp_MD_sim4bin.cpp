...
cout<<"Things are done-2, A_raw is "<<Araw.getVal()<<" +- "<<Araw.getError()<<endl;
  ...
  //DeltaM PLOTING
  RooPlot *xframe_1 =dzero.frame(Bins(28),Title("D^{+} #rightarrow K^{0}_{S} #pi^{+}"));
  ...
  xframe_1->SetMaximum(8200) ;


  RooPlot *xframe_2 = dzero.frame(Bins(28),Title("D^{-} #rightarrow K^{0}_{S} #pi^{-}"));

...
//Signal
  ...
  RooRealVar mean5("mean5","mean5",1.869949,1.85,1.89);
  RooRealVar mean6("mean6","mean6",1.869949,1.85,1.89);
  RooRealVar mean7("mean7","mean7",1.869949,1.85,1.89);
  RooRealVar mean8("mean8","mean8",1.869949,1.85,1.89);

   RooRealVar sig("sig","sig",0.01307,0.008,0.025);
   RooRealVar sigL("sigL","sigL",0.004818,0.002,0.0065);
   RooRealVar sigR("sigR","sigR",0.005236,0.002,0.0065);

   RooRealVar sig2("sig2","sig2",0.01307,0.008,0.025);
   RooRealVar sigL2("sigL2","sigL2",0.004818,0.002,0.0065);
   RooRealVar sigR2("sigR2","sigR2",0.005236,0.002,0.0065);

   RooRealVar sig3("sig3","sig3",0.01307,0.008,0.025);
   RooRealVar sigL3("sigL3","sigL3",0.004818,0.002,0.0065);
   RooRealVar sigR3("sigR3","sigR3",0.005236,0.002,0.0065);

   RooRealVar sig4("sig4","sig4",0.01307,0.008,0.025);
   RooRealVar sigL4("sigL4","sigL4",0.004818,0.002,0.0065);
   RooRealVar sigR4("sigR4","sigR4",0.005236,0.002,0.0065);


  RooRealVar f_Sig("f_Sig","f_Sig",0.247,0,0.4);
  RooRealVar f_Sig2("f_Sig2","f_Sig2",0.247,0,0.4);
  RooRealVar f_Sig3("f_Sig3","f_Sig3",0.247,0,0.4);
  RooRealVar f_Sig4("f_Sig4","f_Sig4",0.247,0,0.4);
...
//Signal - N
  ...
  RooAddPdf Sig_n("Sig_n","Sig_n",RooArgList(sig_n1,sig_n2),f_Sig2);
//Background - N 
...
// BIN-2 --------------------------------------------------------------------------------------
//Signal - P
  RooGaussian sig_p12("sig_p12", "signal Gaussian 12",dzero,mean5,sig3);
  RooBifurGauss sig_p22("sig_p22", "signal Gaussian 22",dzero,mean6,sigL3,sigR3);
...
//  RooBifurGauss sig_p22("sig_p22", "signal Gaussian 22",dzero,mean,sig12,sig22);
  RooAddPdf Sig_p2("Sig_p2","Sig_p2",RooArgList(sig_p12,sig_p22),f_Sig3);
//Background - P  
...
//Signal - N
  RooGaussian sig_n12("sig_n12", "signal Gaussian 12",dzero,mean7,sig4);
  RooBifurGauss sig_n22("sig_n22", "signal Gaussian 22",dzero,mean8,sigL4,sigR4);
...
//  RooBifurGauss sig_n22("sig_n22", "signal Gaussian 22",dzero,mean,sig12,sig22);
  RooAddPdf Sig_n2("Sig_n2","Sig_n2",RooArgList(sig_n12,sig_n22),f_Sig4);
//Background - N 

...
//  TChain* chain=new TChain("h2");
  ...
  chain->Add("KPiPi_exp55_GMC_4s.root");
//  chain->Add(name);
...
//Common
  ...
  RooRealVar mean("mean","mean",1.869387);//,1.86,1.88);
  RooRealVar sig("sig","sig",0.010036);//,0.008,0.016);
  RooRealVar sig1("sig1","sig1",0.003838);//,0.002,0.006);
  RooRealVar sig2("sig2","sig2",0.004017);//,0.002,0.006);
  RooRealVar f_Sig("f_Sig","f_Sig",0.2870);//,0.15,0.5);

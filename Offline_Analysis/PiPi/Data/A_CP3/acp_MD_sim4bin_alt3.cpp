...
//Common
  ...
  RooFormulaVar N_nb("N_nb","(0.5)*(1-A_{Bkg})*N_{Bkg1}",RooArgList(Abkg,N_tb1));
  RooFormulaVar N_pb("N_pb","(0.5)*(1+A_{Bkg})*N_{Bkg1}",RooArgList(Abkg,N_tb1));


  RooRealVar N_tb2("N_{Bkg2}","N_tb2",100,0,1000000);
  RooFormulaVar N_nb2("N_nb2","(0.5)*(1-A_{Bkg})*N_{Bkg2}",RooArgList(Abkg,N_tb2));
  RooFormulaVar N_pb2("N_pb2","(0.5)*(1+A_{Bkg})*N_{Bkg2}",RooArgList(Abkg,N_tb2));

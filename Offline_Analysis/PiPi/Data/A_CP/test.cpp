...
//Signal
  ...
  RooRealVar m_fudge2("mu_{fudge2}","m_fudge2",0.0005,-0.01,0.01);
  RooRealVar s_fudge2("sigma_{fudge2}","s_fudge2",1.0005,0.0,2.0);
  RooFormulaVar m2("m2","1.86806+mu_{fudge2}",RooArgList(m_fudge2));
...
//--------------------------------------------------------------------------------------
//Signal - P2
  RooCBShape Sig_p2("Sig_p2", "Cystal Ball Function", dzero, m2, s2, a, n); 
//Background - P2 
...
//Signal - N2
  RooCBShape Sig_n2("Sig_n2", "Cystal Ball Function", dzero, m2, s2, a, n); 
//Background - N2

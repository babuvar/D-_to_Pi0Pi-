...
//Common
  ...
  RooFormulaVar N_n("N_n","((0.5)*(1-A_{Raw})*N_{Sig}*M2)/(1+M2)",RooArgList(Araw,N_t,M2));
  RooFormulaVar N_n2("N_n2","((0.5)*(1-A_{Raw})*N_{Sig})/(1+M2)",RooArgList(Araw,N_t,M2));
  ...
  RooFormulaVar N_nb("N_nb","((0.5)*(1-A_{Bkg})*N_{Bkg}*Mb2)/(1+Mb2)",RooArgList(Abkg,N_tb,Mb2));
  RooFormulaVar N_nb2("N_nb2","((0.5)*(1-A_{Bkg})*N_{Bkg})/(1+Mb2)",RooArgList(Abkg,N_tb,Mb2));

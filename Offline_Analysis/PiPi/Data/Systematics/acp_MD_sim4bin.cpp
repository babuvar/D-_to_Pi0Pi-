...
double lowlim=1.68;
  RooRealVar dzero("dzero","dzero",lowlim,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.69,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.70,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.71,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.72,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.73,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.74,2.00,"GeV");
//  RooRealVar dzero("dzero","dzero",1.75,2.00,"GeV");
...
if(f_dzero > lowlim  && f_dzero < 2.0){       //~3sigma range to estimate F.O.M.
...
//Signal
  ...
  RooRealVar a("#alpha","a",0.775);//+/-0.024
//  RooRealVar a("#alpha","a",0.799);//   + 0.024
//  RooRealVar a("#alpha","a",0.751);// -0.024

//  RooRealVar n("n","n",10.2);//+/-1.9
//  RooRealVar n("n","n",12.1);
  RooRealVar n("n","n",8.3);

//Background
//Bin-1
  RooRealVar p("p","p",-0.5,-2,0); 
  RooRealVar mean_bkg("mean_bkg","mean_bkg",1.6799,1.60,1.70);
  RooRealVar sig_bkg("sig_bkg","sig_bkg",0.03381,0.03,0.06);
  RooRealVar f("frac_{Bkg1/Bkg2}","f",0.5,0,1); 
//Bin-2
  RooRealVar p2("p2","p2",-0.5,-2,0); 
  RooRealVar sig_bkg2("sig_bkg2","sig_bkg2",0.03381,0.03,0.06);
...
//   RooFitResult* fitRes = simPdf.fitTo(*combData, Minos(kTRUE),Save());

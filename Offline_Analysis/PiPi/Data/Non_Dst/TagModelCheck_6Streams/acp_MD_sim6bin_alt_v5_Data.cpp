...
void acp_MD_sim6bin_alt_v5_Data(void)
{
  //LOAD DATA FILE
  ...
  chain2->Add("pipi_d4s.root");    
  chain2->Add("pipi_d5s.root");    
  chain2->Add("pipi_dcont.root");
...
//Common
  ...
  RooRealVar N_t3("N_{Sig3}","N_t3",78000,45000,225000);
...
//Signal
  ...
  RooRealVar s_fudge("#sigma_{fudge}","s_fudge",1.000,0.95,1.5);
...
//Combinatorial
//Bin-1
  RooRealVar p1("p1","p1",-0.4,-0.6,0.2);
  RooRealVar p2("p2","p2",0.06,0.01,0.2);

//Bin-2
  RooRealVar p1_2("p1_2","p1_2",-0.3,-0.6,0.2);
  RooRealVar p2_2("p2_2","p2_2",0.03,0.01,0.06);


//Bin-3
  RooRealVar p1_3("p1_3","p1_3",-0.3,-1.0,1.0);
  RooRealVar p2_3("p2_3","p2_3",0.03,-1.0,1.0);
...
//Bin-1
  ...
  RooRealVar s_bkg("#sigma_{bkg}","s_bkg",0.04050,0.028,0.044);
...
//Bin-3
  ...
  RooRealVar m_bkg_3("#mu_{bkg_3}","m_bkg_3",1.6672,1.62,1.70);
  RooRealVar s_bkg_3("#sigma_{bkg_3}","s_bkg_3",0.04050,0.028,0.044);
  RooRealVar a_bkg3("#alpha_bkg3","a_bkg3",-1.9634);//,-2.2,-1.80);
...
//Bin-2
RooRealVar f_bkg_2("f_bkg_2","f_bkg_2",0.5,0.0,1.0);


//Bin-3
RooRealVar f_bkg_3("f_bkg_3","f_bkg_3",0.96,0.92,0.99);
...
//Background - P
//  RooChebychev Bkg1_p2("Bkg1_p2", "Bkg1_p2", dzero, RooArgList(p1_2,p2_2));
  RooChebychev Bkg1_p2("Bkg1_p2", "Bkg1_p2", dzero, RooArgList(p1_2));
  RooCBShape Bkg2_p2("Bkg2_p2", "Bkg2_p2", dzero, m_bkg, s_bkg, a_bkg2, n_bkg2); 
  RooAddPdf Bkg_p2("Bkg_p2","Bkg_p2",RooArgList(Bkg1_p2,Bkg2_p2),RooArgList(f_bkg_2));
...
//Background - N  
//Data 
//  RooChebychev Bkg1_n2("Bkg1_n2", "Bkg1_n2", dzero, RooArgList(p1_2,p2_2));
  RooChebychev Bkg1_n2("Bkg1_n2", "Bkg1_n2", dzero, RooArgList(p1_2));
  RooCBShape Bkg2_n2("Bkg2_n2", "Bkg2_n2", dzero, m_bkg, s_bkg, a_bkg2, n_bkg2); 
  RooAddPdf Bkg_n2("Bkg_n2","Bkg_n2",RooArgList(Bkg1_n2,Bkg2_n2),RooArgList(f_bkg_2));
...
//Background - P
  RooChebychev Bkg1_p3("Bkg1_p3", "Bkg1_p3", dzero, RooArgList(p1_3,p2_3));
  RooCBShape Bkg2_p3("Bkg2_p3", "Bkg2_p3", dzero, m_bkg_3, s_bkg_3, a_bkg3, n_bkg3); 
  RooAddPdf Bkg_p3("Bkg_p3","Bkg_p3",RooArgList(Bkg1_p3,Bkg2_p3),RooArgList(f_bkg_3));
...
//Background - N  
//Data 
  RooChebychev Bkg1_n3("Bkg1_n3", "Bkg1_n3", dzero, RooArgList(p1_3,p2_3));
  RooCBShape Bkg2_n3("Bkg2_n3", "Bkg2_n3", dzero, m_bkg_3, s_bkg_3, a_bkg3, n_bkg3);  
  RooAddPdf Bkg_n3("Bkg_n3","Bkg_n3",RooArgList(Bkg1_n3,Bkg2_n3),RooArgList(f_bkg_3));
...
//  simPdf.plotOn(xframe_3,Slice(sample,"pos2"),Components("Bkg2_p2"),ProjWData(sample,*combData),LineStyle(kDashed),LineColor(kGreen));
...
//  simPdf.plotOn(xframe_4,Slice(sample,"neg2"),Components("Bkg2_n2"),ProjWData(sample,*combData),LineStyle(kDashed),LineColor(kGreen));
  ...
  simPdf.plotOn(xframe_5,Slice(sample,"pos3"),Components("Bkg2_p3"),ProjWData(sample,*combData),LineStyle(kDashed),LineColor(kGreen));
  ...
  simPdf.plotOn(xframe_6,Slice(sample,"neg3"),Components("Bkg2_n3"),ProjWData(sample,*combData),LineStyle(kDashed),LineColor(kGreen));

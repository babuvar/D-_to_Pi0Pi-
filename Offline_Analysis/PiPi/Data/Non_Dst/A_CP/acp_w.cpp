...
//Common
  ...
  RooRealVar N_t("N_{Sig}","N_t",107000,90000,145000);
  ...
  RooRealVar N_tb("N_{Bkg}","N_tb",7000000,6500000,8000000);
...
//  RooRealVar s_fudge("#sigma_{fudge}","s_fudge",1.072552);//,0.0,1.7);
  ...
  RooRealVar m("m","m_fudge", 1.86805);
  RooRealVar s("s","s_fudge", 0.015559);
  ...
  RooRealVar c("c","c",-4.0,-5.0,0.1);
  RooRealVar m_b("#mu_bkg","m_b",1.6637);//,1.60,1.75);
  RooRealVar s_b("#sigma_bkg","s_b",0.04141,0.030,0.060);
  RooRealVar a_b("#alpha_bkg","a_bkg",-1.9766);//,-2.0,-1.94);
  RooRealVar n_b("n_bkg","n_bkg",1.13,0.85,10.5);
  RooRealVar f_bkg2_p("f_bkg2_p","f_bkg2_p",0.93,0.87,1.0);
  RooRealVar f_bkg2_n("f_bkg2_n","f_bkg2_n",0.93,0.87,1.0);

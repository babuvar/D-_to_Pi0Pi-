...
//Common Pars
  ...
  RooRealVar s_fudge("#sigma_{fudge}","s_fudge",1.000);//,0.9,1.8);
...
//  RooRealVar p2_n("p2_n","p2_n",0.0,-1,1);
  ...
  RooRealVar s_b("#sigma_bkg","s_b",0.04050,0.030,0.095);
  RooRealVar s_b2("#sigma_bkg2","s_b2",0.04050,0.030,0.047);
...
//  RooRealVar f_bkg2_p("f_bkg2_p","f_bkg2_p",0.95681,0.88,1.0);
//  RooRealVar f_bkg2_n("f_bkg2_n","f_bkg2_n",0.94617,0.88,1.0);

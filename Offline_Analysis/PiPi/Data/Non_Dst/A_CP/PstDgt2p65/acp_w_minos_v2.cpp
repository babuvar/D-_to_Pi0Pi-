...
//Common
  ...
  RooRealVar N_t("N_{Sig}","N_t",78000,45000,95000);
...
//Common Pars
  ...
  RooRealVar c("c","c",-2.3380,-4.5,0.1);
  RooRealVar c2("c2","c2",-2.3380,-4.5,0.1);

   RooRealVar m_b("#mu_bkg","m_b",1.6672,1.52,1.75);
   RooRealVar m_b2("#mu_bkg2","m_b2",1.6672,1.52,1.75);
  RooRealVar s_b("#sigma_bkg","s_b",0.04050,0.025,0.115);
  RooRealVar s_b2("#sigma_bkg2","s_b2",0.04050,0.025,0.115);
//  RooRealVar s_b("#sigma_bkg","s_b",0.04050,0.025,0.051);
  RooRealVar a_b("#alpha_bkg","a_bkg",-1.9024);//,-2.0,-1.94);
  RooRealVar a_b2("#alpha_bkg2","a_bkg2",-2.0134);//,-2.0,-1.94);
  RooRealVar n_b("n_bkg","n_bkg",1.104);//,0.5,5.0);
  RooRealVar n_b2("n_bkg2","n_bkg2",1.189);//,0.5,5.0);
...
//Background - N  
//Data 
  RooExponential Bkg1_n("Bkg1_n", "Bkg1_n", dzero, c2);
  RooCBShape Bkg2_n("Bkg2_n", "Bkg2_n", dzero, m_b2, s_b2, a_b2, n_b2); 

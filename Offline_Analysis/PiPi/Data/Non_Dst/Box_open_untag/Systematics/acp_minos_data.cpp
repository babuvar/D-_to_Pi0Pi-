...
//Common Pars
//Fudge Factors
  RooRealVar m_fudge("#mu_{fudge}","m_fudge",0.0,-0.006,0.006);
...
//  RooRealVar s_fudgeBkg("#sigma_{fudgeBkg}","s_fudgeBkg",1.25,0.85,1.45);
  RooRealVar s_fudgeBkg("#sigma_{fudgeBkg}","s_fudgeBkg",1.32,0.5,2.5);
//  RooRealVar s_fudgeBkg("#sigma_{fudgeBkg}","s_fudgeBkg",1.28,1.1,1.45);

...
//Fudge Factors
  ...
  RooRealVar s_fudge("#sigma_{fudge}","s_fudge",1.069,0.01,2.5);
...
//  RooRealVar s_ratio("#sigma_{ratio}","s_ratio",3.747-0.099);
  ...
  RooRealVar s_fudgeBkg("#sigma_{fudgeBkg}","s_fudgeBkg",1.25,0.81,1.51);
//  RooRealVar m_fudgeBkg("#mu_{fudgeBkg}","m_fudgeBkg",0.0,-0.09,0.09);
//  RooRealVar s_fudgeBkg("#sigma_{fudgeBkg}","s_fudgeBkg",1.25,0.05,2.5);


//Signal
  RooFormulaVar m("m_sig","1.86786+#mu_{fudge}",RooArgList(m_fudge));
  RooFormulaVar s("s","0.015835*#sigma_{fudge}",RooArgList(s_fudge));
  RooRealVar a("#alpha","a",0.905);//,0.01,2.5); 
//  RooRealVar a("#alpha","a",0.905+0.013); 
//  RooRealVar a("#alpha","a",0.905-0.013); 
  RooRealVar n("n","n",2.469);//,0.01,1000); 

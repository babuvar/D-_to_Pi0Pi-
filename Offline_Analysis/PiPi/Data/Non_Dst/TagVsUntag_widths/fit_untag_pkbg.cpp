...
void fit_untag_pkbg(void)
{
  ...
  Int_t nevt=(int)chain2->GetEntries();
  cout<<"nevt\t"<<nevt <<endl;
...
//if(f_Did == 411 || f_Did == -411 ){
//if(f_Did == 421 || f_Did == -421 ){
//if(f_Did == 431 || f_Did == -431 ){
...
//if(f_Did == 411 || f_Did == -411 ){ //D+
//if(f_Did == 421 || f_Did == -421 ){ //D0
//if(f_Did == 431 || f_Did == -431 ){ //Ds

//if(f_Did == 411 || f_Did == -411 || f_Did == 421 || f_Did == -421){//D+D0
//if(f_Did == 421 || f_Did == -421 || f_Did == 431 || f_Did == -431){//DsD0
if(f_Did == 431 || f_Did == -431 || f_Did == 411 || f_Did == -411){//D+Ds

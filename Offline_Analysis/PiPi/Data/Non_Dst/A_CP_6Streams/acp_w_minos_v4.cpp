...
//Common
  ...
  RooRealVar N_t("N_{Sig}","N_t",70,0,145000);
  ...
  RooRealVar N_tb("N_{Bkg}","N_tb",7000,0,22000000);
...
//  RooFormulaVar m_b("#mu_bkg","1.66838+#mu_{fudgeBkg}",RooArgList(m_fudgeBkg));
//  RooFormulaVar s_b("#sigma_bkg","0.04097*#sigma_{fudgeBkg}",RooArgList(s_fudgeBkg));
  RooRealVar m_b("#mu_{bkg}","m_b",1.66838,1.63,1.7);
//  RooRealVar s_b("#sigma_{bkg}","s_b",0.04097,0.01,0.095);
  RooRealVar s_b("#sigma_{bkg}","s_b",0.045,0.02,0.095);
...
//  RooRealVar n_b2("n_bkg2","n_bkg2",1.190);
  ...
  RooRealVar f_bkg2_p("f_bkg2_p","f_bkg2_p",0.95681,0.92,0.99);
  RooRealVar f_bkg2_n("f_bkg2_n","f_bkg2_n",0.94617,0.92,0.99);
...
TPad *pad32_p = new TPad("pad32_p", "The pad 20% of the height",0.0,0.0,1.0,0.2,0);
  ...
  pad31_m->cd() ; gPad->SetLeftMargin(0.15) ;TGaxis::SetMaxDigits(2); gPad->SetBottomMargin(0.15); xframe_1->Draw() ;
  pad31_p->cd() ; gPad->SetLeftMargin(0.15) ; gPad->SetBottomMargin(0.15); frame1->Draw() ;

  pad32_m->cd() ; gPad->SetLeftMargin(0.15) ;TGaxis::SetMaxDigits(2); gPad->SetBottomMargin(0.15); xframe_2->Draw() ;

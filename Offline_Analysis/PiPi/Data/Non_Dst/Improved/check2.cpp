...
TH1D* data_p=new TH1D("data_p", "data_p", 100, 1.68, 2.06);
TH1D* data_n=new TH1D("data_n", "data_n", 100, 1.68, 2.06);
TH1D* data_p2=new TH1D("data_p2", "data_p2", 100, 1.68, 2.06);
TH1D* data_n2=new TH1D("data_n2", "data_n2", 100, 1.68, 2.06);
...
//Fit
 ...
 //    Model_n.paramOn(xframe_2,data_N); 
  ...
  simPdf.plotOn(xframe_3,Slice(sample,"pos2"),Components("Sig_p"),ProjWData(sample,*combData),LineStyle(kDashed),LineColor(kRed));
  simPdf.plotOn(xframe_3,Slice(sample,"pos2"),Components("Bkg_p"),ProjWData(sample,*combData),LineStyle(kDashed));
   Model_p.paramOn(xframe_3,data_P);
  ...
  simPdf.plotOn(xframe_4,Slice(sample,"neg2"),Components("Sig_n"),ProjWData(sample,*combData),LineStyle(kDashed),LineColor(kRed));
  simPdf.plotOn(xframe_4,Slice(sample,"neg2"),Components("Bkg_n"),ProjWData(sample,*combData),LineStyle(kDashed));

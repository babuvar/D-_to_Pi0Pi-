...
//  RooRealVar n("n","n",16.44);//,13,30);
  ...
  RooRealVar n("n","n",16.44);//,13,20);



  RooRealVar p("p","p",-0.2,-10,0.01); 
  RooRealVar p2("p2","p2",-0.2,-10,0.01); 

  RooRealVar mean_bkg("#mu_{bkg}","mean_bkg",1.6799,1.38,1.70);
  RooRealVar mean_bkg2("#mu_{bkg2}","mean_bkg2",1.6799,1.38,1.70);

  RooRealVar sig_bkg("#sigma_{bkg}","sig_bkg",0.038,0.02,0.2);
  RooRealVar sig_bkg2("#sigma_{bkg2}","sig_bkg2",0.038,0.02,0.2);

  RooRealVar f("frac_{Bkg1/Bkg2}","f",0.85,0.80,1.0); 
  RooRealVar f2("frac2_{Bkg1/Bkg2}","f",0.85,0.80,1.0); 

//Signal - P
  RooCBShape Sig_p("Sig_p", "Cystal Ball Function", dzero, m, s, a, n); 
//Background - P  
  RooExponential bkg1_p("bkg1_p", "bkg1_p", dzero, p);
...
//MC
  RooExponential bkg1_n("bkg1_n", "bkg1_n", dzero, p2);

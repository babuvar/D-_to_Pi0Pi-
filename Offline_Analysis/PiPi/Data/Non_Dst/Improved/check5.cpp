...
//Common Pars
  ...
  RooRealVar a("#alpha","a",0.7937);//,0.6,0.9);
  RooRealVar n("n","n",16.44);//,10,25);

  RooRealVar p("p","p",0.0,-10,0.1); 
  RooRealVar mean_bkg("#mu_{bkg}","mean_bkg",1.6799,1.5,1.70);
  RooRealVar mean_bkg2("#mu_{bkg2}","mean_bkg2",1.6799,1.5,1.70);
  RooRealVar sig_bkg("#sigma_{bkg}","sig_bkg",0.038,0.0,1);
  RooRealVar sig_bkg2("#sigma_{bkg2}","sig_bkg2",0.038,0.0,1);
  RooRealVar f("frac_{Bkg1/Bkg2}","f",0.85,0.7,1.0); 
  RooRealVar f2("frac2_{Bkg1/Bkg2}","f2",0.85,0.7,1.0); 
...
//Background - P  
  ...
  RooGaussian bkg3_p("bkg3_p", " Gaussian 1",dzero,mean_bkg2,sig_bkg2);
  RooAddPdf bkg_p("bkg_p","bkg_p",RooArgList(bkg2_p,bkg3_p),RooArgList(f2));
  RooAddPdf Bkg_p("Bkg_p","Bkg_p",RooArgList(bkg1_p,bkg_p),RooArgList(f));
//Full Model - P
...
//Background - N  
  ...
  RooGaussian bkg3_n("bkg3_n", " Gaussian 1",dzero,mean_bkg2,sig_bkg2);
  RooAddPdf bkg_n("bkg_n","bkg_n",RooArgList(bkg2_n,bkg3_n),RooArgList(f2));
  RooAddPdf Bkg_n("Bkg_n","Bkg_n",RooArgList(bkg1_n,bkg_n),RooArgList(f));
//Full Model - N

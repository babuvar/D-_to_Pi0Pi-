...
//  RooRealVar p1_n("p1_n","p1_n",-0.4,-0.8,0.01);
...
//  RooRealVar p1_n2("p1_n2","p1_n2",-0.3,-0.8,0.01);
//  RooRealVar p2_p2("p2_p2","p2_p2",0.03,0.01,0.2);
//  RooRealVar p2_n2("p2_n2","p2_n2",0.03,0.01,0.2);
...
//   RooRealVar m_bkg_n2("#mu_{bkg_n2}","m_bkg_n2",1.6672,1.63,1.74);
//  RooRealVar s_bkg2("#sigma_{bkg2}","s_bkg2",0.04050,0.020,0.095);
  RooRealVar s_bkg2("#sigma_{bkg2}","s_bkg2",0.04050,0.030,0.095);
//  RooRealVar s_bkg_n2("#sigma_{bkg_n2}","s_bkg_n2",0.04050,0.030,0.095);

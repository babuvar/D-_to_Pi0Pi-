...
//Common Pars - II
  ...
  RooRealVar m2("m2","m2",1.6799,1.64,1.70);
  RooRealVar s2("s2","s2",0.03381,0.02,0.043);
  RooGaussian Sig("Sig", " Gaussian 2",dzero,m2,s2);
  RooRealVar p("p","p",-0.5,-5,0);
  RooChebychev Sig2("Sig2", "Sig2", dzero, RooArgList(p)); 
  RooRealVar f("f","f",0.5,0,1); 
  RooAddPdf Model("Model","Model",RooArgList(Sig,Sig2),RooArgList(f));

...
//Bin-1
  ...
  RooRealVar mean_bkg("mean_bkg","mean_bkg",1.6799,1.6,1.70);
...
//Bin-2
  ...
  RooRealVar mean_bkg2("mean_bkg2","mean_bkg2",1.6799,1.6,1.70);
...
//--------------------------------------------------------------------------------------
//Signal - P2
  RooCBShape Sig_p2("Sig_p2", "Cystal Ball Function", dzero, m, s2, a2, n2); 
//Background - P2 
...
//Signal - N2
  RooCBShape Sig_n2("Sig_n2", "Cystal Ball Function", dzero, m, s2, a2, n2); 
//Background - N2

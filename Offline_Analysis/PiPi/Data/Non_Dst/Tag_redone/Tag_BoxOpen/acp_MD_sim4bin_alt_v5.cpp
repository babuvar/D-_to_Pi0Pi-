...
//Fit
  ...
  TPad *mad12 = new TPad("mad12", "The mad 20% of the height",0.5,0.0,1.0,1.0,0);
    mad11->Draw();
    mad12->Draw();
  TCanvas* can6 = new TCanvas("c6","c6") ;
  TPad *mad21 = new TPad("mad21", "The mad 80% of the height",0.0,0.0,0.5,1.0,0);
  TPad *mad22 = new TPad("mad22", "The mad 20% of the height",0.5,0.0,1.0,1.0,0);
    mad21->Draw();
    mad22->Draw();
...
TPad *mad12_p = new TPad("mad32_p", "The mad 20% of the height",0.0,0.0,1.0,0.25,0);
    ...
    mad12_p->Draw();
mad21->cd();
TPad *mad21_m = new TPad("mad33_m", "The mad 80% of the height",0.0,0.25,1.0,1.0,0);
TPad *mad21_p = new TPad("mad33_p", "The mad 20% of the height",0.0,0.0,1.0,0.25,0);
    mad21_m->Draw();
    mad21_p->Draw();
mad22->cd();
TPad *mad22_m = new TPad("mad34_m", "The mad 80% of the height",0.0,0.25,1.0,1.0,0);
TPad *mad22_p = new TPad("mad34_p", "The mad 20% of the height",0.0,0.0,1.0,0.25,0);
    mad22_m->Draw();
    mad22_p->Draw();
//-------------------------------------------------------------------------------------
pad31->cd();
...
//-------------------------------------------------------------------------------------
  mad11_m->cd() ; gPad->SetLeftMargin(0.15) ; gPad->SetRightMargin(0.01) ;   gPad->SetBottomMargin(0.15); gPad->SetTopMargin(0.01);  dframe1->Draw() ;  line->Draw();
  mad11_p->cd() ; gPad->SetLeftMargin(0.15) ; gPad->SetRightMargin(0.01) ;   gPad->SetBottomMargin(0.02); frame1->Draw() ;  line->Draw();

  mad12_m->cd() ; gPad->SetLeftMargin(0.01) ; gPad->SetRightMargin(0.15) ;   gPad->SetBottomMargin(0.15); gPad->SetTopMargin(0.01);  dframe2->Draw() ;  line->Draw();
  mad12_p->cd() ; gPad->SetLeftMargin(0.01) ; gPad->SetRightMargin(0.15) ;   gPad->SetBottomMargin(0.02); frame2->Draw() ;  line->Draw();

  mad21_m->cd() ; gPad->SetLeftMargin(0.15) ; gPad->SetRightMargin(0.01) ;   gPad->SetBottomMargin(0.15); gPad->SetTopMargin(0.01);  dframe3->Draw() ;  line->Draw();
  mad21_p->cd() ; gPad->SetLeftMargin(0.15) ; gPad->SetRightMargin(0.01) ;   gPad->SetBottomMargin(0.02); frame3->Draw() ;  line->Draw();

  mad22_m->cd() ; gPad->SetLeftMargin(0.01) ; gPad->SetRightMargin(0.15) ;  gPad->SetBottomMargin(0.15); gPad->SetTopMargin(0.01);  dframe4->Draw() ;  line->Draw();
  mad22_p->cd() ; gPad->SetLeftMargin(0.01) ; gPad->SetRightMargin(0.15) ;  gPad->SetBottomMargin(0.02); frame4->Draw() ;  line->Draw();
//-------------------------------------------------------------------------------------
...
cout<<"Abkg1  = "<<Abkg1.getVal()<<" +/- "<<Abkg1.getError()<<endl;

cout<<"Abkg2  = "<<Abkg2.getVal()<<" +/- "<<Abkg2.getError()<<endl;

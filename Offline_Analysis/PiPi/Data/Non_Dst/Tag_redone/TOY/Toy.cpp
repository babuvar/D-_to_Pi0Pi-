...
//  RooPlot* frame2 = mcstudy->plotError(Araw,0.019,0.024,40) ;
  ...
  RooPlot* frame6 = mcstudy->plotPull(N_t1,Bins(40),FitGauss(kTRUE)) ;
  RooPlot* frame4 = mcstudy->plotParam(N_t1,Bins(40)) ;
//  RooPlot* frame5 = mcstudy->plotError(N_t1,Bins(40)) ;
  RooPlot* frame5 = mcstudy->plotError(N_t1,110,180,40) ;

  RooPlot* frame9 = mcstudy->plotPull(N_t2,Bins(40),FitGauss(kTRUE)) ;
  RooPlot* frame7 = mcstudy->plotParam(N_t2,Bins(40)) ;
//  RooPlot* frame8 = mcstudy->plotError(N_t2,Bins(40)) ;
  RooPlot* frame8 = mcstudy->plotError(N_t2,90,140,40) ;
  ...
  TCanvas* can2 = new TCanvas("MC Study2","MC Study2",900,900) ;
  can2->Divide(3,2) ;

  can2->cd(1) ; gPad->SetLeftMargin(0.15) ; frame4->GetYaxis()->SetTitleOffset(1.4) ; frame4->Draw() ;
  can2->cd(2) ; gPad->SetLeftMargin(0.15) ; frame5->GetYaxis()->SetTitleOffset(1.4) ; frame5->Draw() ;
  can2->cd(3) ; gPad->SetLeftMargin(0.15) ; frame6->GetYaxis()->SetTitleOffset(1.4) ; frame6->Draw() ;

  can2->cd(4) ; gPad->SetLeftMargin(0.15) ; frame4->GetYaxis()->SetTitleOffset(1.4) ; frame7->Draw() ;
  can2->cd(5) ; gPad->SetLeftMargin(0.15) ; frame5->GetYaxis()->SetTitleOffset(1.4) ; frame8->Draw() ;
  can2->cd(6) ; gPad->SetLeftMargin(0.15) ; frame6->GetYaxis()->SetTitleOffset(1.4) ; frame9->Draw() ;

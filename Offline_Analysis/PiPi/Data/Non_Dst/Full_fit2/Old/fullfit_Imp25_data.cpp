...
//Common
  ...
  RooRealVar N_t("N_{Sig}","N_t",35000,25000,95000);
...
//Signal
  ...
  RooRealVar s_fudge("#sigma_{fudge}","s_fudge",1.066);//,0.9,1.2);
...
//Background 
  ...
  RooExponential Bkg1("Bkg1", "Bkg1", dzero, c);
   ...
   RooRealVar m_b("#mu_bkg","m_b",1.6637,1.52,1.69);
  RooRealVar s_b("#sigma_bkg","s_b",0.04141,0.028,0.085);
  RooRealVar a_b("#alpha_bkg","a_bkg",-1.9766);//,-2.1,-1.8);
  RooRealVar n_b("n_bkg","n_bkg",1.13);//,0.04,5.0);


  RooCBShape Bkg2("Bkg2", "Bkg2", dzero, m_b, s_b, a_b, n_b); 
  RooRealVar f_bkg("f_bkg","f_bkg",0.93,0.90,1.0);

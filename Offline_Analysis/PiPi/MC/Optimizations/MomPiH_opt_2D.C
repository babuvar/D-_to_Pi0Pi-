...
float numbins=400;
float width1=(4.75 -0.75)/numbins;
float width2=(4.75 -0.75)/numbins;
...
for(int i=0;i<numbins;i++){cut1[i]=0.75+(i*width1); cut2[i]=0.75+(i*width2);}
...
//    for(int i=0;i<1000;i++)
   {
      ...
      chain->GetEntry(i);
stopbin1=floor((f_Pizmom-0.75)/width1);
stopbin2=floor((f_Pimom-0.75)/width2);
...
if(f_Pizmom > 0.75 && f_Pizmom < 4.75){
if(f_Pimom > 0.75 && f_Pimom < 4.75){

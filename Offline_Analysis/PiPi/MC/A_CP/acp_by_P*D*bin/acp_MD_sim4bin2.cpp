...
//Bin-1
  ...
  RooRealVar mean_bkg1("#mu_{bkg1}","mean_bkg1",1.6799,1.65,1.70);
  RooRealVar sig_bkg1("#sigma_{bkg1}","sig_bkg1",0.03381,0.03,0.04);
...
//Bin-2
  ...
  RooRealVar sig_bkg2("#sigma_{bkg2}","sig_bkg2",0.03381,0.03,0.044);
...
//Background - P  
  ...
  RooGaussian bkg2_p("bkg2_p", " Gaussian 1",dzero,mean_bkg1,sig_bkg1);
...
//Background - N  
  ...
  RooGaussian bkg2_n("bkg2_n", " Gaussian 2",dzero,mean_bkg1,sig_bkg1);
...
//Background - P2 
  ...
  RooGaussian bkg2_p2("bkg2_p2", " Gaussian 12",dzero,mean_bkg1,sig_bkg2);
...
//Background - N2
  ...
  RooGaussian bkg2_n2("bkg2_n2", " Gaussian 22",dzero,mean_bkg1,sig_bkg2);
...
cout<<"Things are done-2, A_raw is "<<Araw.getVal()<<" +- "<<Araw.getError()<<endl;
  ...
  RooPlot *xframe_3 =dzero.frame(Bins(30),Title("D^{+} #rightarrow #pi^{0} #pi^{+}"));
  ...
  RooPlot *xframe_4 = dzero.frame(Bins(30),Title("D^{-} #rightarrow #pi^{0} #pi^{-}"));

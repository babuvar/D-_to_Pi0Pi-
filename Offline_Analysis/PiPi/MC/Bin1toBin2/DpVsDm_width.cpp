...
//Background - P 
  RooChebychev Bkg_p("Bkg_p", "Bkg_p", dzero, RooArgList(p));

//Full Model - P
  RooAddPdf Model_p("Model_p","Model_p",RooArgList(Sig_p,Bkg_p),RooArgList(N_p,N_pb));

//Signal - N
  RooCBShape Sig_n("Sig_n", "Cystal Ball Function", dzero, m, s2, a, n); 

//Background - N  
  RooChebychev Bkg_n("Bkg_n", "Bkg_n", dzero, RooArgList(p));

...
basf <<EOF >! ./log_MC_5s_$5/log_$FILE.out
...
histogram define ./hbook_MC_5s_$5/$FILE.hbk  



process_url http://bweb3/montecarlo.php?ex=$3&rs=$1&re=$2&ty=evtgen-$4&dt=5S_onresonance&bl=caseB&st=$5

...
basf <<EOF >! ./log_index_DataFull_continuum/log_$FILE.out
...
histogram define ./hbook_index_DataFull_continuum/$FILE.hbk  

process_event  /home/belle/varghese/Reco_KPiPi/index_Data_continuum/$FILE 0

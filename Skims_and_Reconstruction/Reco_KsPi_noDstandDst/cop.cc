...
void dtokspi::hist_def(void)
{
  ...
  nt_dpipi_small = BASF_Histogram->ntuple("information for mode d to pipi with deltam","DStarMass DCharge  DeltaM DMass PstDst PstD PKsPi1 PKsPi2 EGam1s EGam2s KsMass KsMom PiZsMass PiMom PiCThet  PiZsMom Gam1sThe Gam2sThe Categ  DstID DID PiZsID KsID PiID DstF DF PiZsF KsF PiF  Exp Run Evt", 1);

  nt_dpipi_big = BASF_Histogram->ntuple("information for mode d to pipi","DMass DCharge  PstD  Gam1hThe Gam2hThe EGamma1 EGamma2 PiZMass  PiZMom  PiMom  PiCThet PiDR PiDZ PiPID  DID PiZID PiID  DF PiZF  PiF Exp Run Evt", 2);

...
basf <<EOF >! ./log_data_cont/log_$FILE.out


path create main
path create Skim

module register fix_mdst dtokspi
path add_module main fix_mdst
path add_module Skim dtokspi
...
histogram define ./hbook_data_cont/$FILE.hbk


process_url http://bweb3/mdst.php?ex=$3&rs=$1&re=$2&skm=HadronBorJ&dt=continuum&bl=caseB
